...
use minecrust::packets::play::entity_position::{
...
use minecrust::packets::play::player_position::{
    InPlayerPosition, InPlayerPositionRotation, InPlayerRotation, OutPlayerPositionLook,
    OutViewPosition,
};
use minecrust::packets::play::spawn_player::SpawnPlayer;
use minecrust::types::{Receive, Send, Size, TAsyncRead, TAsyncWrite, VarInt};
use piper::Arc;
    ...
    W: TAsyncWrite,
{
    let _first = true;
    loop {
        let size = reader.receive::<VarInt>().await?;

        let mut packet = Vec::with_capacity(*size as usize);
        size.send(&mut packet).await?;

        let packet_id = reader.receive::<VarInt>().await?;
        ...
        let server_to_client = vec![
            ...
            *Ping::PACKET_ID,
            0x02,
            *LoginRequest::SUCCESS_PACKET_ID,
            0x05,
            *SpawnPlayer::PACKET_ID,
            0x08, /* Acknowledge Player Digging */
            0x0C,
            *BlockChange::PACKET_ID,
            0x0F,
            *OutChatMessage::PACKET_ID,
            0x21,
            *KeepAlive::PACKET_ID,
            0x22,
            *Chunk::PACKET_ID,
            ...
            *JoinGame::PACKET_ID,
            0x29,
            *OutPosition::PACKET_ID,
            0x2A,
            *OutPositionRotation::PACKET_ID,
            0x2B,
            *OutRotation::PACKET_ID,
            0x34,
            *PlayerInfo::PACKET_ID,
            0x36,
            *OutPlayerPositionLook::PACKET_ID,
            0x38,
            *DestroyEntity::PACKET_ID,
            0x3C,
            *OutEntityHeadLook::PACKET_ID,
            // 0x1E, /* Unload chunk */
            // 0x3E, /* World border */
            // 0x25, /* Update light */
            // 0x4F, /* Time update */
            0x41,
            *OutViewPosition::PACKET_ID,
        ];
